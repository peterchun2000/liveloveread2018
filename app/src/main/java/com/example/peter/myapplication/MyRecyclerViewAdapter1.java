...
public class MyRecyclerViewAdapter1 extends RecyclerView.Adapter<MyRecyclerViewAdapter1.ViewHolder> {
    ...
    public MyRecyclerViewAdapter1(Context mInflater, List<BookCls> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.recyclerview_row1, null);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.date.setText(book1.getDate());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView titleview, authorview, date;
        ImageView imageView;
